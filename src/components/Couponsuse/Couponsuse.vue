    ...
    <div class="" v-for="item in couponD" v-if="show">
      <div v-bind:class="{coupon_used:state==3,coupon_no:state!=3}" @click="selectCoupons(item)">
        <div class="coupon vux-1px" >
          ...
          <img v-if="state==3" src="./images/coupon_2_03.png" alt="">
          <div class="left" >
          ...
          <div class="right">
            ...
            <p class="explain">
              ...
              <span class="use_explain" v-if="item.state==0" @click.stop="showexplain(item)">使用说明</span>
            </p>
          </div>
        </div>
      </div>
    </div>
    <div class="couponsnone" v-if="!couponD.length&&state!=3">
