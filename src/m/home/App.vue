<template>
	<div id="home">
		<div v-if="showContent">
			...
			<div v-if="indexdata.lives&&indexdata.lives.items.length>0">
				<TitleBar :title="indexdata.lives.name" more="查看全部" :img="indexdata.lives.image" line="line" url="/m/lives.html"></TitleBar>
				<div v-for="(item,index) in indexdata.lives.items" :key="index">
			...
			<articles :articlelist="indexdata.articles.items"></articles>
			<div class="load">
